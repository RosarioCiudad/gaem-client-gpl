...
public class MenuSectionAdapter extends BaseAdapter {
    ...
    public MenuSectionAdapter(Context context) {
    	mData = new ArrayList<MenuSectionItem>();
    	mCheckBoxesSet = new TreeSet<Integer>();
        ...
        if (convertView == null) {
            ...
            switch (type) {
                case TYPE_POPUP_VIEW:
                    ...
                    holder.labelView = (TextView)convertView.findViewById(R.id.list_item_popup_title);
                    holder.descriptionView = (TextView)convertView.findViewById(R.id.list_item_popup_caption);
                    break;
                case TYPE_CHECKBOX_VIEW:
                    convertView = mInflater.inflate(R.layout.list_item_check, null);
                    convertView.setTag(holder);
                    holder.labelView = (TextView)convertView.findViewById(R.id.list_item_check_title);
                    holder.descriptionView = (TextView)convertView.findViewById(R.id.list_item_check_caption);
                    break;
            }
        } else {
	...
	public static class MenuSectionItem {
		...
		public MenuSectionItem(int type, String label, String description) {
			this.label = label;
